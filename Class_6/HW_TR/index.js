...
function loadCarsForSale(carsList) {
    carsList = carsForSale
    clearTable()
...
function loadCarsForRental(carsList) {
    carsList = carsForRental
    clearTable()
    const firstElement = carsList[0]
    const fields = Object.keys(firstElement)
    console.log(firstElement)
...
// loadCars(carsForSale)

const Cars = [...carsForSale, ...carsForRental];

function loadAllCars(carsList) {
    carsList = Cars
    clearTable()
    const firstElement = carsList[0]
    const fields = Object.keys(firstElement)
